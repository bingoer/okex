package com.weber.okex.ticker.okexclient.rest.future;
...
public interface IFutureRestApi {
     ...
     */
      ...
      */
       ...
       * @throws IOException
      */
      public String future_trade(String symbol, String contractType, String price, String amount,
          String type, String matchPrice) throws HttpException, IOException;
